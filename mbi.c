...
void update_Non_Clinic_Budget( float *n)
{
    ...
    scanf("%f",&nv);
    *n = nv;
    N_C_B.Tot_Budget = N_C_B.Infras + N_C_B.Janitors + N_C_B.Technicians;
    FILE *f;
    f = fopen("nonclinic.bin","wb");
    fwrite(&N_C_B,sizeof(struct Non_Clinic_Budget),1,f);
    fclose(f);
}
...
printf("press any other key to go back\n");
                ...
                if(c==1)
                {switch(ch2)
                    {case '1': update_Laboratory(&Lab.Tools_Equipment);
                                goto b;
                                break;
                    case '2': update_Laboratory(&Lab.Chemicals);
                                goto b;
                                break;
                    default: goto b;
...
printf("press any other key to go back\n");
          ...
          ch2 = getch();
                if(c==1)
                {switch(ch2)
                    {case '1': update_Clinic_Budget(&C_B.P_C_costs);
                                goto b;
                                break;
                    case '2': update_Clinic_Budget(&C_B.Faci_Admin);
                                goto b;
                                break;
                    default: goto b;
                   }
    ...
    fclose(fptr3);
      ...
      case '4': {
          ...
          printf("\n Individual budget");
          printf("\n 1. Infrastructure \t%f",N_C_B.Infras);
          printf("\n 2. Technician \t%f",N_C_B.Technicians);
...
printf("press any other key to go back\n");
            ...
            ch2 = getch();
                if(c==1)
                {switch(ch2)
                    {case '1': update_Non_Clinic_Budget(&N_C_B.Infras);
                                goto b;
                                break;
                    case '2': update_Non_Clinic_Budget(&N_C_B.Technicians);
                                goto b;
                                break;
                    case '3': update_Non_Clinic_Budget(&N_C_B.Janitors);
                                 goto b;
                                break;
                    default: goto b;
                   }
    ...
    fclose(fptr4);
      ...
      printf("\n Individual budget");
printf("\n 1. Clinical Pharmacy \t %f",Phar.Clinical);
...
printf("press any other key to go back\n");
            ch2 = getch();
                if(c==1)
                {switch(ch2)
                    {case '1': update_Pharmacy(&Phar.Clinical);
                                goto b;
                                break;
                    case '2': update_Pharmacy(&Phar.Industrial);
                                goto b;
                                break;
                    case '3': update_Pharmacy(&Phar.Compounding);
                                goto b;
                                break;
                    default: goto b;
                   }
...
printf("press any other key to go back\n");
    ...
    fclose(fptr7);
      ...
      printf("\n Individual budget");
printf("\n 1. Cardiology \t %f",MS.Cardiology);
printf("\n 2. Nephrology \t %f",MS.Nephrology);
...
printf("press any other key to go back\n");
            ...
            ch2 = getch();
                if(c==1)
                {switch(ch2)
                    {case '1': update_Dept_MS(&MS.Cardiology);
                                goto b;
                                break;
                    case '2': update_Dept_MS(&MS.Nephrology);
                                goto b;
                                break;
                    case '3': update_Dept_MS(&MS.Neurology);
                                goto b;
                                break;
                    default: goto b;
                    }
...
printf("press any other key to go back\n");
            ch2 = getch();
                if(c==1)
                {switch(ch2)
                    {case '1': update_Dept_Surgery(&Sur.Cardiovascular);
                                goto b;
                                break;
                    case '2': update_Dept_Surgery(&Sur.Thoracic);
                                goto b;
                                break;
                    default: goto b;
                    }
